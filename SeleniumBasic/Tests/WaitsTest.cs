...
namespace SeleniumAdvanced.Tests
{
    public class WaitsTest : BaseTest
    {
        ...
        {
            //с неявным ожиданием (установить, например, в 10 сек). Пройдет в дебаг-режиме, в обычном - как повезет
        ...
        {
            WaitsHelper waitsHelper = new WaitsHelper(Driver,TimeSpan.FromSeconds(5));
            Driver.Navigate().GoToUrl("http://the-internet.herokuapp.com/dynamic_loading/1");
